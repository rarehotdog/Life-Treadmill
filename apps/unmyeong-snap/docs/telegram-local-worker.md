...
<plist version="1.0">
  <dict>
    ...
    <array>
      ...
      <string>-lc</string>
      <string>cd '/Users/taehyeonkim/Documents/New project/apps/unmyeong-snap' && npm run telegram:ops:run -- market_3h local_queue && npm run telegram:local:worker -- --once</string>
    </array>
